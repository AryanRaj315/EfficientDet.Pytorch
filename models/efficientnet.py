...
class MBConvBlock(nn.Module):
    ...
    def __init__(self, block_args, global_params):
        ...
        if self._block_args.expand_ratio != 1:
            ...
            self._bn0 = nn.GroupNorm(num_groups=2, num_channels=oup, eps=1e-05, affine=True)
        ...
        self._bn1 = nn.GroupNorm(num_groups=2, num_channels=oup, eps=1e-05, affine=True)
        ...
        self._bn2 = nn.GroupNorm(num_groups=2, num_channels=final_oup, eps=1e-05, affine=True)
...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        self._bn0 = nn.GroupNorm(num_groups=2, num_channels=out_channels, eps=1e-05, affine=True)
        ...
        self._bn1 = nn.GroupNorm(num_groups=2, num_channels=out_channels, eps=1e-05, affine=True)
